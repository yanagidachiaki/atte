...
class AttendanceController extends Controller
{
    ...
    //     // 勤怠データを取得（日付でフィルタリング）
    //     $works = Work::whereDate('start', $date)
    ...
    //     return view('attendance', compact('works', 'date'))->with('displayDate', $date->format('Y-m-d'));
    //   }     
    ...
    // 勤怠データをページネーションで取得
    $works = $worksQuery->paginate(5);  // 1ページに5件表示
